  ...
  return (
    <section className="common-padding">
      <div className="screen-max-width">
        ...
        <div className="flex flex-col items-center">
          <h2 className="hiw-title">
            ну а если крайне лень читать, предлагаем посмотреть видео о корабле:
          </h2>
          <div className="mt-2 md:mt-4 mb-4">
            <div className="relative h-full flex-center">
              <div className="overflow-hidden">
          ...
          <a href="https://youtu.be/dQw4w9WgXcQ?si=WFEfhy0NICLzSAE6" className="hiw-text" target="_blank" rel="noopener noreferrer">для просмотра онлайн без регистрации и смс просто нажмите на этот текст</a>
        </div>
      </div>
    </section>
  );
